const Card = ({title, author,time, body, img}) => {
  return (
    <div className="flex justify-center mt-10">
      <div className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row sm:max-w-xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        <img
        ...
        <div className="flex flex-col justify-between p-4 leading-normal">
          ...
          <h5 className="mb-2 text-lg font-light tracking-tight text-gray-900 dark:text-white">
            author <span className="italic">Time</span>
          </h5>
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 truncate-words">
